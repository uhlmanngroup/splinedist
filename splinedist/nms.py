...
def non_maximum_suppression_3d(
    ...
    inds = non_maximum_suppression_3d_inds(
        disti, points, rays=rays, scores=probi, thresh=nms_thresh, verbose=verbose
    )
...
def non_maximum_suppression_3d_sparse(
    dist, prob, points, rays, b=2, nms_thresh=0.5, verbose=False
):
    ...
    inds = non_maximum_suppression_3d_inds(
        disti, pointsi, rays=rays, scores=probi, thresh=nms_thresh, verbose=verbose
    )
...
def non_maximum_suppression_3d_inds(
    dist, points, rays, scores, thresh=0.5, use_bbox=True, verbose=1
):
    """
